...
각각 "구체적"인지로 센다.
  · 구체적 = 특정 가능한 정보. 장소는 상호·출구·교차로 등 콕 집을 수 있는 지점("역 3번 출구"), \
시각은 시계·수치 표현("3시쯤","30분 전","방금"), 외모는 색+품목 등 식별 단서("빨간 패딩").
  · 모호 = 언급은 있으나 특정 불가("동네","아까","파란 옷인 것 같은데 모르겠음").
  등급: "상" = 세 요소가 모두 구체적이고 앞뒤가 맞음. "중" = 구체적 요소가 1~2개(또는 세 요소가 \
언급되나 대부분 모호해 부분적으로만 좁혀짐). "하" = 구체적 요소가 하나도 없고 전반이 불확실 \
("잘 모르겠다","비슷한 사람","그냥 신고")이라 좁힐 단서가 없음.
