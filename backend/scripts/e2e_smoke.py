...
case = step("2 실종 신고", client.post("/phase1/reports", json={
    ...
    "lkp_time": "2026-07-11T17:30:00", "persona_id": p["id"],
...
print(f"   대상 셀 {n_cells if isinstance(n_cells, int) else len(n_cells)}개")
...
tip = step("6 제보 접수", client.post(f"/phase3/cases/{cid}/tips", json={
    ...
    "seen_at": "2026-07-11T18:10:00", "with_photo": False}))
