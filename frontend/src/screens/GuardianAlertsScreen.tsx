...
const styles = StyleSheet.create({
  ...
  title: { position: 'absolute', left: 20, top: 27, fontFamily: type.family, fontSize: 18, lineHeight: 23, fontWeight: '800', color: '#000000', zIndex: 1 },
  subtitle: { position: 'absolute', left: 20, top: 63, fontFamily: type.family, fontSize: 11, lineHeight: 13, fontWeight: '500', color: '#8E8E93', zIndex: 1 },
