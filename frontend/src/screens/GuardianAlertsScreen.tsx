...
const styles = StyleSheet.create({
  ...
  title: { position: 'absolute', left: 20, top: 27, fontFamily: type.familyCssBold, fontSize: 18, lineHeight: 23, color: '#000000', zIndex: 1 },
  subtitle: { position: 'absolute', left: 20, top: 63, fontFamily: type.familyCssBold, fontSize: 11, lineHeight: 13, color: '#8E8E93', zIndex: 1 },
  ...
  reportCount: { position: 'absolute', left: 26, top: 131, fontFamily: type.familyCssBold, fontSize: 11, lineHeight: 13, color: '#525253', zIndex: 1 },
