...
const styles = StyleSheet.create({
  ...
  accountKey: { fontFamily: type.familyCss, fontSize: 12, color: '#909090' },
  accountVal: { flex: 1, textAlign: 'right', fontFamily: type.familyCssSemiBold, fontSize: 13, color: '#4D4D4D', marginLeft: 12 },
  accountBtn: { paddingVertical: 12, borderTopWidth: 1, borderTopColor: '#EDEDED' },
  accountBtnPressed: { opacity: 0.6 },
  accountBtnText: { fontFamily: type.familyCssSemiBold, fontSize: 13, color: color.brand },
  logoutText: { color: '#909090' },
  safe: { flex: 1, backgroundColor: '#FFFFFF' }, content: { paddingHorizontal: 23, paddingTop: 27, paddingBottom: 40 }, title: { fontFamily: type.familyCssExtraBold, fontSize: 18, lineHeight: 23, color: '#000000' }, hero: { height: 103, borderRadius: 10, backgroundColor: color.figmaField, marginTop: 14 },
  metrics: { flexDirection: 'row', gap: 15, marginTop: 30 }, metric: { flex: 1, height: 50, borderRadius: 10, backgroundColor: color.figmaField, alignItems: 'center', justifyContent: 'center' }, metricLabel: { fontFamily: type.familyCssSemiBold, fontSize: 11, lineHeight: 13, letterSpacing: 0.07, color: color.figmaGray }, metricValue: { fontFamily: type.familyCssExtraBold, fontSize: 18, lineHeight: 23, marginTop: 2 },
  section: { fontFamily: type.familyCssSemiBold, fontSize: 18, lineHeight: 23, color: '#000000', marginTop: 40 }, recentSection: { marginTop: 31 }, badges: { height: 103, borderRadius: 10, backgroundColor: color.figmaField, marginTop: 11, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }, badge: { alignItems: 'center', width: 70 }, badgeIcon: { fontSize: 28 }, badgeLabel: { fontFamily: type.familyCss, fontSize: 13, lineHeight: 18, letterSpacing: -0.08, color: '#525253', marginTop: 3, textAlign: 'center' },
  recent: { height: 73, borderRadius: 10, backgroundColor: color.figmaField, marginTop: 12, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center' }, recentTitle: { fontFamily: type.familyCssBold, fontSize: 17, lineHeight: 22, letterSpacing: -0.41, color: '#525253' }, recentDate: { fontFamily: type.familyCss, fontSize: 11, lineHeight: 13, letterSpacing: 0.07, color: '#525253', marginTop: 8 }, km: { position: 'absolute', left: 100, top: 17, minWidth: 62, borderRadius: 10, backgroundColor: '#D7D7D7', paddingHorizontal: 10, paddingVertical: 2, fontFamily: type.familyCss, fontSize: 11, lineHeight: 13, letterSpacing: 0.07, color: '#525253' }, chevron: { position: 'absolute', right: 16, fontFamily: type.familyCss, fontSize: 26, color: color.guardian },
});
