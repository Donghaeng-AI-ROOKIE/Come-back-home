...
| Phase 2 마음 재해석 | 행동 LoRA (`MIND_MODEL=exaone-mind-v5`) | 게이지 발동 시 행동·목표·혼란 등급 재해석 | RAG 미사용 |
...
- **물리 상한**은 도달 가능성입니다. `v_max`는 Phase 3 제보 신뢰도가 쓰는 상수를 그대로 재사용합니다(치매 4.32, 지적장애 5.0 km/h — 문헌 근거, 2026-07-29). 전부 도보 기준이며 대중교통은 반영하지 않습니다(2026-07-24 안1).
